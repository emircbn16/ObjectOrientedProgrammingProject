...
"")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Tasarim\\Images/Icon/güneşikon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-radius:21px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_4.setText(_translate("Form", "Lisanssız Güneş Enerji Santralleri"))
